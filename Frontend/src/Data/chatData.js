export const chatData = [
  ...
  },
  {
    ...
    responses: [
      {
        en: "Aggressive Style. Sport Ring Velocity wheel caps feature a striking red ring. 🔴",
        hi: "Aggressive Style. Sport Ring Velocity wheel caps mein ek laal ring hai jo attention kheenchti hai. 🔴",
      },
      {
        en: "Durable finish that resists scratching.",
        hi: "Iska rang jaldi kharab nahi hota.",
      },
      {
        en: "Instant sporty upgrade for any car.",
        hi: "Kisi bhi gaadi ko foran sporty bana deta hai.",
      },
    ],
  },
  {
    id: "prod_matte_stealth",
    keywords: [
      "matte black stealth",
      "stealth cap",
      "full black cap",
    ...
    responses: [
      {
        en: "Undercover Cool. Matte Black Stealth caps are for the understated look. 🕶️",
        hi: "Chupa Rustom. Matte Black Stealth caps shant aur cool dikhte hai. 🕶️",
      },
      {
        en: "Smooth matte finish that feels premium.",
        hi: "Matte finish haath lagane mein bhi premium lagta hai.",
      },
      {
        en: "Perfect for a de-chromed look.",
        hi: "Agar chrome pasand nahi toh yeh best hai.",
      },
    ],
  },
  ...
  {
    id: "prod_grey_artisan",
    keywords: ["grey artisan mat", "custom mat", "grey mat", "mat 36"],
    responses: [
      {
        en: "Sophisticated Choice. Grey Custom Artisan Mat blends perfectly with modern interiors. 🩶",
        hi: "Samajhdaar Choice. Grey Custom Artisan Mat modern interiors ke saath mast match hota hai. 🩶",
      },
      {
        en: "Hand-crafted finish for a premium feel.",
        hi: "Haath se banaya hua premium feel deta hai.",
      },
      {
        en: "Hides dust better than black mats.",
        hi: "Black mats se zyada dhool chupata hai.",
      },
    ],
  },
  {
    id: "prod_heavy_vulcan",
    keywords: ["heavy duty vulcan", "vulcan mat", "tough mat", "mat 37"],
    responses: [
      {
        en: "Built Tough. Heavy Duty Vulcan Mat is designed for rough usage. 🔨",
        hi: "Mazboot Bana Hai. Heavy Duty Vulcan Mat rough use ke liye design kiya gaya hai. 🔨",
      },
      {
        en: "Extra thick material for longevity.",
        hi: "Lambi life ke liye extra mota material.",
      },
      {
        en: "Easy to wash and dry quickly.",
        hi: "Dhona aasaan aur sookhta bhi jaldi hai.",
      },
    ],
  },
  ...
  {
    id: "prod_areon_ken",
    keywords: ["areon ken", "ken gel", "areon perfume", "air freshener 102"],
    responses: [
      {
        en: "Long Lasting Freshness. Areon Ken Gel Fragrance is a global favorite. 🌍",
        hi: "Lambi Khushbu. Areon Ken Gel Fragrance puri duniya mein pasand kiya jata hai. 🌍",
      },
      {
        en: "Anti-spill gel formula safe for dashboards.",
        hi: "Girne ka dar nahi, dashboard ke liye safe hai.",
      },
      {
        en: "Available in Black Crystal, Anti-Tobacco, and more.",
        hi: "Black Crystal, Anti-Tobacco jaise flavours mein milta hai.",
      },
    ],
  },
  {
    id: "prod_lavender_lush",
    keywords: [
      "lavender lush",
      "lavender diffuser",
      "calm scent",
    ...
    responses: [
      {
        en: "Calm Drive. Lavender Lush Car Diffuser creates a relaxing atmosphere. 💜",
        hi: "Shant Drive. Lavender Lush Car Diffuser ekdum relaxing mahaul banata hai. 💜",
      },
      {
        en: "Real lavender extracts to reduce stress.",
        hi: "Stress kam karne ke liye asli lavender use kiya hai.",
      },
      {
        en: "Perfect for city traffic jams.",
        hi: "City traffic mein dimaag shant rakhne ke liye best hai.",
      },
    ],
  },
  {
    ...
    responses: [
      {
        en: "Cute & Fragrant. Aromahpure Hanging Pod looks good and smells great. 🌸",
        hi: "Sunder aur Meheka. Aromahpure Hanging Pod dikhta bhi accha hai aur mehekta bhi. 🌸",
      },
      {
        en: "Continuous fragrance release for up to 45 days.",
        hi: "45 din tak lagatar khushbu deta rehta hai.",
      },
      {
        en: "Natural essential oils inside.",
        hi: "Iske andar natural tel hai.",
      },
    ],
  },
  {
    ...
    responses: [
      {
        en: "Traditional Luxury. Premium Sandalwood Grain Perfume for a woody aroma. 🪵",
        hi: "Paramparik Luxury. Premium Sandalwood Perfume chandan ki khushbu deta hai. 🪵",
      },
      {
        en: "Rich scent that feels very premium.",
        hi: "Khushbu aisi ki ameer waali feeling aaye.",
      },
      {
        en: "Create a temple-like serenity in your car.",
        hi: "Gaadi mein mandir jaisi shanti banao.",
      },
    ],
  },
  ...
  {
    id: "prod_precision_window",
    keywords: ["precision window", "clarity film", "sun film 46"],
    responses: [
      {
        en: "Crystal Clear. Precision Window Clarity film rejects heat without darkening. 👓",
        hi: "Ekdum Saaf. Precision Window Clarity film garmi rokti hai bina andhera kiye. 👓",
      },
      {
        en: "Maintains night driving visibility perfectly.",
        hi: "Raat ko gaadi chalane mein koi dikkat nahi hoti.",
      },
      {
        en: "Good UV protection for your skin.",
        hi: "Aapki skin ke liye acchi UV protection deta hai.",
      },
    ],
  },
  ...
  },
  {
    ...
    responses: [
      {
        en: "Step into Style. Footwell Glow Kit lights up your floor area. 👣",
        hi: "Style mein aao. Footwell Glow Kit floor area ko roshan karta hai. 👣",
      },
      {
        en: "Soft glow that doesn't distract the driver.",
        hi: "Halki roshni jo driver ko pareshan nahi karti.",
      },
      {
        en: "Welcomes you every time you open the door.",
        hi: "Darwaza kholte hi aapka swagat karti hai.",
      },
    ],
  },
  {
    ...
    responses: [
      {
        en: "Dreamy Drive. Starry Roof Ambience brings the galaxy to your car ceiling. ✨",
        hi: "Sapno jaisi Drive. Starry Roof Ambience chhat pe taare le aata hai. ✨",
      },
      {
        en: "Inspired by ultra-luxury cars like Rolls Royce.",
        hi: "Rolls Royce jaisi mehengi gaadiyon se inspired hai.",
      },
      {
        en: "Twinkling effect available.",
        hi: "Timtimane wala effect bhi hai.",
      },
    ],
  },
  {
    id: "prod_hyper_beam",
    keywords: ["hyper beam", "200w led", "coo white led", "headlight bulb 402"],
    responses: [
      {
        en: "Focus & Range. Cool White 200W Hyper Beam gives immense throw. 🔦",
        hi: "Focus aur Range. Cool White 200W Hyper Beam dur tak roshni visible karta hai. 🔦",
      },
      {
        en: "Perfect for highway driving.",
        hi: "Highway driving ke liye best hai.",
      },
      {
        en: "Instant start-up, no warm-up time needed.",
        hi: "Button dabate hi full power, rukna nahi padta.",
      },
    ],
  },
  {
    id: "prod_hyundai_alpha",
    keywords: [
      "hyundai alpha",
      "222w led",
      "hyundai led",
    ...
    responses: [
      {
        en: "Made for Hyundai. Hyundai 222W Alpha 1 LED fits perfectly. 🚘",
        hi: "Hyundai ke liye bana hai. Hyundai 222W Alpha 1 LED perfect fit hota hai. 🚘",
      },
      {
        en: "Canbus ready - no error codes on dashboard.",
        hi: "Dashboard pe koi error light nahi aayegi.",
      },
      {
        en: "Superior brightness for older models.",
        hi: "Purane models ke liye zabardast brightness.",
      },
    ],
  },
  {
    id: "prod_osram_bulb",
    keywords: ["osram led", "osram bulb", "50w led", "headlight bulb 405"],
    responses: [
      {
        en: "German Quality. Osram H4H19 LED Bulb 50W is reliable and sharp. 🇩🇪",
        hi: "German Quality. Osram LED Bulb bharosemand aur sharp hai. 🇩🇪",
      },
      {
        en: "Correct beam pattern prevents blinding oncoming traffic.",
        hi: "Iska focus sahi hai, saamne wale ko andha nahi karta.",
      },
      {
        en: "Long life span backed by Osram warranty.",
        hi: "Lambi life aur Osram ki warranty.",
      },
    ],
  },
  ...
  {
    id: "prod_fuse_relay",
    keywords: ["car fuse relay", "fuse", "relay", "electronics 503"],
    responses: [
      {
        en: "Safety First. Car Fuse Relay protects your expensive electronics. 🛡️",
        hi: "Suraksha Pehle. Car Fuse Relay aapke mehenge electronics ko bachata hai. 🛡️",
      },
      {
        en: "High quality copper contacts for better flow.",
        hi: "Acchi quality ka copper use kiya hai.",
      },
      {
        en: "Essential upgrade when adding heavy lights or horns.",
        hi: "Bhari lights ya horn lagate waqt zaroori hai.",
      },
    ],
  },
  {
    id: "prod_horn_relay",
    keywords: ["horn relay", "loud horn kit", "electronics 504"],
    responses: [
      {
        en: "Be Heard. Horn Relay extracts maximum volume from your horns. 📢",
        hi: "Sunaai Dena Chahiye. Horn Relay horn ki awaaz full tezz karta hai. 📢",
      },
      {
        en: "Protects your steering horn switch from melting.",
        hi: "Steering ke horn switch ko jalne se bachata hai.",
      },
      {
        en: "Must-have for dual horn setups.",
        hi: "Do horn lagane ke liye zaroori hai.",
      },
    ],
  },
  {
    id: "prod_rca_cable",
    keywords: ["rca cable", "audio cable", "rca wire", "electronics 505"],
    responses: [
      {
        en: "Clean Signal. RCA Audio Cable ensures noise-free music transmission. 🎵",
        hi: "Saaf Signal. RCA Audio Cable bina khar-khar ke music bajata hai. 🎵",
      },
      {
        en: "Gold plated connectors for better contact.",
        hi: "Gold plated connectors hai acche contact ke liye.",
      },
      {
        en: "Thick shielding blocks engine noise interference.",
        hi: "Moti parat engine ki awaaz ko rokhti hai.",
      },
    ],
  },
  ...
  },
  {
    ...
    responses: [
      {
        en: "For best pricing, please Call/WhatsApp Owner Tanveer Sir: +91 9822119832 📞",
        hi: "Sahi rate ke liye Owner Tanveer Sir ko Call/WhatsApp karein: +91 9822119832 📞",
      },
      {
        en: "Prices depend on your car model. Call +91 9822119832 for a quote.",
        hi: "Price gaadi ke model pe depend karta hai. Quote ke liye +91 9822119832 pe call karein.",
      },
      {
        en: "We guarantee the best market rates! Contact +91 9822119832.",
        hi: "Market mein sabse best rate milega! +91 9822119832 pe sampark karein.",
      },
    ],
  },
  {
  ...
  },
  {
    ...
    responses: [
      {
        en: "Upgrade your dashboard! 🖥️ We have Android Players from 9 inch to 13 inch (2K QLED).",
        hi: "Dashboard upgrade karo! 🖥️ Humare paas 9 inch se 13 inch tak Android Players hai.",
      },
      {
        en: "Brands: Gemstone, Oncord, Sansui, Nippon.",
        hi: "Gemstone, Oncord, Sansui, Nippon sab original milega.",
      },
      {
        en: "Wireless CarPlay & Android Auto available.",
        hi: "Wireless CarPlay aur Android Auto bhi hai.",
      },
    ],
  },
  {
    id: "mats",
    keywords: ["mat", "floor", "7d", "9d", "flooring", "carpet"],
    responses: [
      {
        en: "Keep it Clean! 🧹 We have 7D & 9D Luxury Mats that trap dust.",
        hi: "Gaadi saaf rakho! 🧹 7D aur 9D Luxury Mats dhool ko pakad lete hai.",
      },
      {
        en: "Custom fitting for every car model. Easy to wash.",
        hi: "Har gaadi ki fitting available hai. Dhona bhi aasaan hai.",
      },
      {
        en: "Available in Black, Beige, Coffee, and Tan colors.",
        hi: "Black, Beige, Coffee aur Tan colours mein mil jayega.",
      },
    ],
  },
  {
    ...
    responses: [
      {
        en: "Protect your Paint! 🛡️ Paint Protection Film (PPF) heals self-scratches.",
        hi: "Paint ko bachao! 🛡️ PPF se scratches khud gayab ho jate hai.",
      },
      {
        en: "We use Garware and Llumar TPU films with 5-year warranty.",
        hi: "Hum Garware aur Llumar ki TPU film use karte hai 5 saal ki warranty ke saath.",
      },
      {
        en: "Keeps your car shining like new for years.",
        hi: "Gaadi saalon tak nayi jaisi chamkegi.",
      },
    ],
  },
  {
    ...
    responses: [
      {
        en: "Address: Next to Greenland Hotel, Chavindra, Bhiwandi, 421302. \n[Click for Contact Info](/contact)",
  ...
  },
  {
    ...
    responses: [
      ...
      {
        en: "Tanveer Sir is available on this number. +91 9822119832",
        hi: "Tanveer Sir isi number pe milenge. +91 9822119832",
      },
      {
