...
const ContactUs = () => {
  ...
  const contactSchema = {
    ...
    "@type": "ContactPage",
    name: "Contact Captain Car Studio",
    description:
      "Contact information for Captain Car Studio, including phone numbers, email, and address in Bhiwandi.",
    url: "https://captaincarstudio.in/contact",
    mainEntity: {
      "@type": "LocalBusiness",
      name: "Captain Car Studio",
      image: "https://captaincarstudio.in/logo.png",
      telephone: "+91-9822119832",
      address: {
        "@type": "PostalAddress",
    ...
    <div className="min-h-screen bg-[#050505] text-white pt-10 font-sans selection:bg-[#E31E24] selection:text-white relative overflow-hidden">
      ...
      <div className="max-w-7xl w-full mx-auto px-6 relative z-10">
        ...
        <ScrollReveal direction="down">
          <div className="text-left mb-24 md:pl-14 lg:pl-26">
            ...
            <h1 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter mb-8 leading-[0.8] flex flex-col items-start">
              Reach{" "}
              <span className="text-[#E31E24] skew-x-[-10deg]">Captain.</span>
            </h1>
            <p className="text-gray-400 text-sm md:text-base max-w-2xl font-light leading-relaxed">
              ...
              <br />
              Our experts are ready to turn your automotive dreams into
              reality...
            </p>
          </div>
        </ScrollReveal>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-16 items-start">
          ...
          <div className="lg:col-span-5 space-y-8">
                ...
                >
                  <div className="group relative bg-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 hover:border-[#E31E24]/40 transition-all duration-500 hover:shadow-[0_20px_40px_rgba(0,0,0,0.5)]">
                    ...
                    <div className="flex gap-6 relative z-10">
                      <div
                        className={`w-16 h-16 shrink-0 rounded-2xl bg-[#0d0d0d] border border-white/10 flex items-center justify-center group-hover:bg-[#E31E24] group-hover:border-[#E31E24] transition-all duration-500 shadow-xl group-hover:scale-110`}
                      >
                        <div
                          className={`fill-[#E31E24] group-hover:fill-white transition-colors`}
                        >
                          {method.icon}
                        </div>
                      </div>
                      <div>
                        <h3 className="text-lg font-black uppercase italic mb-1 tracking-tight">
                          {method.title}
                        </h3>
                        <p className="text-gray-500 text-[10px] uppercase tracking-widest mb-4 font-bold">
                          {method.subtitle}
                        </p>
            ...
            <ScrollReveal direction="up" delay={400}>
              <div className="bg-gradient-to-r from-[#1a0505] to-[#0a0a0a] border border-white/5 rounded-[2rem] p-8 mt-12 relative overflow-hidden">
                <h4 className="text-sm font-bold uppercase tracking-[0.3em] mb-6 text-gray-500 underline decoration-[#E31E24] underline-offset-8">
                  Follow Our Work
                </h4>
                <div className="grid grid-cols-2 gap-4">
                  ...
                  >
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-white group-hover:text-[#E31E24] transition-colors">
                      Instagram
                    </span>
                  </a>
                  ...
                  >
                    ...
                    <span className="text-xs font-black uppercase tracking-widest text-white group-hover:text-[#FF0000] transition-colors">
                      YouTube
                    </span>
                  </a>
                </div>
          ...
          <ScrollReveal
            direction="right"
            delay={200}
            className="lg:col-span-7 lg:-mt-60 lg:translate-x-12"
          >
            <div className="bg-[#080808] border border-white/10 rounded-[3rem] p-10 md:p-14 shadow-2xl relative overflow-hidden group">
              ...
              {submitted ? (
                <div className="text-center py-20 animate-fade-in relative z-10">
                  ...
                  <h4 className="text-3xl font-black text-white uppercase italic mb-4">
                  ...
                  >
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                      <div className="relative group/input">
                        <label className="text-[10px] font-black text-[#E31E24] uppercase tracking-[0.3em] ml-4 mb-2 block">
                          {" "}
                          Name
                        </label>
                        <input
      ...
      <div className="relative h-[600px] w-full mt-20 group">
        ...
        <div className="absolute top-10 left-1/2 -translate-x-1/2 z-20 px-8 py-3 bg-[#0a0a0a]/80 backdrop-blur-md rounded-full border border-white/10 group-hover:border-[#E31E24]/50 transition-all">
          <span className="text-xs font-black uppercase tracking-[0.3em] text-[#E31E24]">
            Live Navigation
          </span>
        </div>
        <iframe
