...
const WhyUs = () => {
  ...
  const images = [
    {
      src: "/modified-seltos.png",
      alt: "Captain Edition Seltos",
      label: "Side View",
    },
    {
      src: "/modified-seltos-interior.png",
  ...
  return (
    <div className="bg-black text-white min-h-screen pt-32 font-sans selection:bg-[#E31E24] selection:text-white overflow-hidden relative">
      <Seo
        title="Why Choose Captain Car"
        description="Discover why Captain Car is the best car decor studio in Bhiwandi. We offer zero-wire cutting installation, genuine products, and 100% warranty support."
        keywords="car decor bhiwandi, best car accessories shop, genuine car parts, car technician, warranty safe modification"
        url="/why-us"
      />
          ...
          <div className="flex flex-col md:flex-row items-center justify-between gap-12 mb-24">
            ...
            <div className="w-full md:w-1/2 text-left">
              <div className="inline-block px-4 py-2 rounded-full border border-white/10 bg-white/5 mb-6 backdrop-blur-md">
                <span className="text-[#E31E24] text-xs font-black uppercase tracking-[0.3em]">
                  The Captain Difference
                </span>
              </div>
              <h1 className="text-4xl md:text-7xl font-black uppercase italic tracking-tighter mb-8 leading-[0.9]">
                Why We Are <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E31E24] to-red-600">
                  The Best Choice.
                </span>
              </h1>
              <p className="text-gray-400 text-lg md:text-xl font-medium leading-relaxed mb-8">
                In Bhiwandi, many shops modify cars. But at{" "}
                <strong>Captain Car</strong>, we don't just fit parts we create
                art. We give you peace of mind, genuine quality, and a car that
          ...
          {[
            ...
            <ScrollReveal key={idx} direction="up" delay={idx * 150}>
              <div className="bg-[#0a0a0a] border border-white/10 p-10 rounded-[2.5rem] text-center hover:border-[#E31E24]/50 hover:-translate-y-2 transition-all duration-500 group relative overflow-hidden">
                ...
                <h3 className="text-6xl font-black text-white italic tracking-tighter mb-2 group-hover:text-[#E31E24] transition-colors">
                  {stat.number}
                </h3>
                <p className="text-[#E31E24] font-bold uppercase tracking-widest text-sm mb-2">
                  {stat.label}
                </p>
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 group">
                ...
                <div className="relative bg-gradient-to-br from-[#111] to-black border border-white/10 p-8 rounded-[2.5rem] h-[320px] flex items-center justify-center overflow-hidden group-hover:border-[#E31E24]/50 transition-all duration-500 shadow-2xl">
                  ...
                  <div className="relative flex items-center gap-1">
                    ...
                    <div className="flex flex-col gap-2 transform group-hover:translate-x-2 transition-transform duration-500">
                      <div className="w-12 h-3 bg-gray-600 rounded-l-md relative">
                        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-1 bg-green-500 rounded-full shadow-[0_0_10px_#22c55e]"></div>
                      </div>
                      <div className="w-12 h-3 bg-gray-600 rounded-l-md relative">
                        <div className="absolute right-0 top-1/2 -translate-y-1/2 w-4 h-1 bg-green-500 rounded-full shadow-[0_0_10px_#22c55e]"></div>
                      </div>
              ...
              <div className="w-full md:w-1/2 text-left order-2 md:order-2">
                <h3 className="text-3xl md:text-5xl font-black uppercase italic tracking-tighter mb-6 leading-none">
                  ...
                  <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#E31E24] to-orange-500">
                    Warranty Safe.
                  </span>
                </h3>
                <p className="text-gray-400 text-base md:text-lg leading-relaxed text-justify hyphens-auto tracking-tight break-words mb-8 border-l-4 border-[#E31E24] pl-6">
                  Many local mechanics cut your car's original wiring to fit
                  accessories. This can be dangerous and voids your company
                  warranty. At Captain Car, we use professional Coupler to
                  Coupler fittings. This means we simply plug in the new system
                  without cutting a single wire. Your car remains safe, new, and
                  warranty protected.
                </p>
                <div className="flex flex-wrap gap-4">
                  <span className="px-6 py-3 bg-white/5 rounded-xl text-xs font-black uppercase tracking-widest text-white border border-white/10 hover:bg-[#E31E24] hover:border-[#E31E24] transition-all cursor-default">
                    Plug & Play
                  </span>
                  <span className="px-6 py-3 bg-white/5 rounded-xl text-xs font-black uppercase tracking-widest text-white border border-white/10 hover:bg-[#E31E24] hover:border-[#E31E24] transition-all cursor-default">
                    Safety First
            ...
            <div className="flex flex-col md:flex-row gap-12 group">
              ...
              <div className="w-full md:w-1/2 text-left order-2 md:order-1">
                ...
                <p className="text-gray-400 text-base md:text-lg leading-relaxed text-justify hyphens-auto tracking-tight break-words mb-8 border-l-4 border-green-500 pl-6">
                  The market is full of cheap copy products that look like the
                  real thing but stop working after a few months. We are
                  straightforward we sell Only Original. Whether it is Sony,
                  JBL, Pioneer, or Mozo, you get the real deal with a proper GST
                  Bill and Company Warranty. We value your trust more than
                  profit.
                </p>
                <div className="flex flex-wrap gap-4">
                  <span className="px-6 py-3 bg-white/5 rounded-xl text-xs font-black uppercase tracking-widest text-white border border-white/10 hover:bg-green-600 hover:border-green-600 transition-all cursor-default">
                    Official Dealer
                  </span>
                  <span className="px-6 py-3 bg-white/5 rounded-xl text-xs font-black uppercase tracking-widest text-white border border-white/10 hover:bg-green-600 hover:border-green-600 transition-all cursor-default">
                    GST Bill
              ...
              <div className="w-full md:w-1/2 relative order-1 md:order-2">
                ...
                <div className="relative bg-gradient-to-bl from-[#111] to-black border border-white/10 p-8 rounded-[2.5rem] h-[320px] flex items-center justify-center overflow-hidden group-hover:border-green-500/50 transition-all duration-500 shadow-2xl">
                  ...
                  <div className="relative">
                    ...
                    <svg
                      className="w-32 h-32 fill-none stroke-green-500 stroke-[1.5] drop-shadow-[0_0_15px_rgba(34,197,94,0.5)]"
                      viewBox="0 0 24 24"
                    >
                      <path
                        strokeLinecap="round"
            ...
            <div className="flex flex-col md:flex-row items-center gap-12 group">
              <div className="w-full md:w-1/2 relative order-1 md:order-1">
                ...
                <div className="relative bg-gradient-to-br from-[#111] to-black border border-white/10 p-8 rounded-[2.5rem] h-[320px] flex items-center justify-center overflow-hidden group-hover:border-yellow-500/50 transition-all duration-500 shadow-2xl">
                  ...
                  <div className="relative group-hover:scale-110 transition-transform duration-500">
                    <svg
                      className="w-32 h-32 fill-none stroke-yellow-500 stroke-[1.5] drop-shadow-[0_0_15px_rgba(234,179,8,0.5)]"
                      viewBox="0 0 24 24"
                    >
                      <path
                        strokeLinecap="round"
                    ...
                    <div className="absolute -top-2 -right-2 transform rotate-12">
                      <svg
                        className="w-12 h-12 fill-yellow-500 animate-bounce"
                        viewBox="0 0 24 24"
                      >
              ...
              <div className="w-full md:w-1/2 text-left order-2 md:order-2">
                ...
                <p className="text-gray-400 text-base md:text-lg leading-relaxed text-justify hyphens-auto tracking-tight break-words mb-8 border-l-4 border-yellow-500 pl-6">
                  Most shops forget the customer once the work is done. Not us.
                  If you face any small issue in wiring, setting, or sound
                  turning even after 1 year, just come to the shop. We provide
                  Lifetime Service Support for our installation. Your
                  satisfaction is our long-term asset.
                </p>
                <div className="flex flex-wrap gap-4">
                  <span className="px-6 py-3 bg-white/5 rounded-xl text-xs font-black uppercase tracking-widest text-white border border-white/10 hover:bg-yellow-600 hover:border-yellow-600 transition-all cursor-default">
                    Always Available
                  </span>
                  <span className="px-6 py-3 bg-white/5 rounded-xl text-xs font-black uppercase tracking-widest text-white border border-white/10 hover:bg-yellow-600 hover:border-yellow-600 transition-all cursor-default">
                    Family Treatment
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <ScrollReveal direction="up" delay={100}>
              <div className="bg-[#0a0a0a] border border-white/10 p-8 rounded-[2rem] hover:border-[#E31E24]/50 transition-all duration-500 group relative overflow-hidden h-full">
                ...
                <div className="w-16 h-16 rounded-2xl bg-[#111] border border-white/10 flex items-center justify-center mb-8 shadow-lg group-hover:scale-110 transition-transform duration-500">
                  <svg className="w-8 h-8 fill-[#E31E24]" viewBox="0 0 24 24">
                    <path d="M22.7 19l-9.1-9.1c.9-2.3.4-5-1.5-6.9-2-2-5-2.4-7.4-1.3L9 6 6 9 1.6 4.7C.4 7.1.9 10.1 2.9 12.1c1.9 1.9 4.6 2.4 6.9 1.5l9.1 9.1c.4.4 1 .4 1.4 0l2.3-2.3c.5-.4.5-1.1.1-1.4z" />
                  </svg>
                </div>

                <h3 className="text-2xl font-black text-white uppercase italic mb-6 group-hover:text-[#E31E24] transition-colors">
                  Superior Service
                </h3>
                ...
                <ul className="space-y-4">
                  {[
                    {
                      text: "Expert Technicians (15+ Years)",
                      icon: "M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zm0 2c-2.67 0-8 1.34-8 4v2h16v-2c0-2.66-5.33-4-8-4z",
                    },
                    {
                      text: "Same Day Installation",
                      icon: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8zm.5-13H11v6l5.25 3.15.75-1.23-4.5-2.67z",
                    },
                    {
                      text: "Free Lifetime Tuning",
                    ...
                    {
                      text: "Clean Invisible Wiring",
                      icon: "M9 16.17L4.83 12l-1.42 1.41L9 19 21 7l-1.41-1.41z",
                    },
                  ].map((item, i) => (
                    <li key={i} className="flex items-center gap-3">
                      <svg
                        className="w-5 h-5 fill-gray-500 shrink-0"
                        viewBox="0 0 24 24"
                      >
                        <path d={item.icon} />
                      </svg>
            ...
            <ScrollReveal direction="up" delay={200}>
              <div className="bg-[#1a0505] border border-[#E31E24] p-8 rounded-[2rem] relative overflow-hidden h-full transform md:-translate-y-4 shadow-[0_0_50px_rgba(227,30,36,0.2)]">
                ...
                <h3 className="text-2xl font-black text-[#E31E24] uppercase italic mb-6">
                  Unbeatable Pricing
                </h3>
              ...
              <div className="bg-[#0a0a0a] border border-white/10 p-8 rounded-[2rem] hover:border-[#E31E24]/50 transition-all duration-500 group relative overflow-hidden h-full">
                ...
                <ul className="space-y-4">
                  {[
                    ...
                    {
                      text: "1-3 Year Manufacturer Warranty",
                      icon: "M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z",
                    },
                    {
                      text: "No Refurbished / Fake Items",
        ...
        <ScrollReveal direction="up">
          <div className="bg-[#080808] border border-white/5 rounded-[3rem] p-8 md:p-14 mb-24 relative overflow-hidden">
            ...
            <h2 className="text-3xl font-black uppercase italic tracking-tighter text-center mb-16">
              Captain Car{" "}
              <span className="text-gray-600 text-xl mx-4 not-italic font-medium normal-case">
                vs
              </span>{" "}
              Local Garage
            </h2>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-12 gap-4 pb-4 border-b border-white/10 text-xs md:text-sm uppercase tracking-widest font-black text-gray-500">
                ...
                <div className="col-span-3 md:col-span-4 text-center text-[#E31E24]">
                  Captain Car
                </div>
              ...
              {[
                {
                  ...
                  captain: "100% Original",
                  local: "Mix / Fake Copies",
                },
                {
                  name: "Installation type",
                  captain: "Coupler-to-Coupler",
                  local: "Wire Cutting / Taping",
                },
                {
                  name: "Car Warranty",
                  captain: "Safe & Active",
                  local: "High Risk Void",
                },
                {
                  name: "Technicians",
                  captain: "15+ Years Expert",
                  local: "Learning Boys",
                },
                {
                  name: "After Service",
                  captain: "Lifetime Support",
                  local: "No Guarantee",
                },
                {
                  name: "Pricing",
                  captain: "Fixed & Fair",
                  local: "Hidden Charges",
                },
              ].map((row, i) => (
                <div
                  key={i}
                  className="grid grid-cols-12 gap-4 items-center py-6 border-b border-white/5 hover:bg-white/5 transition-colors rounded-xl px-4"
                >
                  <div className="col-span-5 md:col-span-4 font-bold text-white text-sm md:text-lg">
                    {row.name}
                  </div>
                  <div className="col-span-3 md:col-span-4 text-center font-black text-[#E31E24] italic bg-[#E31E24]/10 py-1 rounded-lg text-xs md:text-base border border-[#E31E24]/20">
                    {row.captain}
                  </div>
                  <div className="col-span-4 md:col-span-4 text-center text-gray-500 text-xs md:text-sm font-medium">
                    {row.local}
                  </div>
                </div>
              ))}
