...
const Home = () => {
  ...
  const faqs = [
    {
      q: "Do you provide warranty on modifications?",
      a: "Yes! All our products come with a verified manufacturer warranty, and we provide a lifetime installation guarantee on our wiring work.",
    },
    {
      q: "Will installing accessories affect my car's warranty?",
      a: "We use coupler-to-coupler installation methods which do not cut any original wires, ensuring your car's manufacturer warranty remains intact.",
    },
    {
      q: "How long does a full interior customization take?",
      a: "Seat covers usually take 3-4 hours. A complete interior overhaul (audio + lights + seats) might take a full day. We value precision over speed.",
    },
    {
      q: "Do you have options for all car brands?",
      a: "Absolutely. From Maruti to Mercedes, we have specific accessories tailored for every make and model.",
    },
  ];
    ...
    <div className="bg-premium-black text-white font-sans overflow-x-hidden selection:bg-brand-red selection:text-white">
      ...
      <div className="relative w-full h-screen flex flex-col items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          >
            <source
              src="/assets/captain/final-thar-video.mp4"
              type="video/mp4"
            />
          </video>
        </div>
          ...
          <ScrollReveal direction="left" delay={500} className="w-full">
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-black mb-6 leading-[0.9] md:leading-[0.85] uppercase italic tracking-tighter drop-shadow-2xl">
              <div className="flex gap-4">
                <span
                  className={`block text-white transition-all duration-700 delay-[0ms] transform ${showHeroText ? "translate-y-0 opacity-100" : "translate-y-[100%] opacity-0"}`}
                >
                  CRAFT
                </span>
                <span
                  className={`block text-white transition-all duration-700 delay-[200ms] transform ${showHeroText ? "translate-y-0 opacity-100" : "translate-y-[100%] opacity-0"}`}
                >
                  YOUR
                </span>
              </div>
              <div className="flex gap-4 overflow-visible">
                <span
                  className={`block text-transparent bg-clip-text bg-gradient-to-r from-[#DC143C] to-[#FF6B6B] filter drop-shadow-[0_0_20px_rgba(220,20,60,0.5)] transition-all duration-700 delay-[400ms] transform pr-2 ${showHeroText ? "translate-y-0 opacity-100" : "translate-y-[100%] opacity-0"}`}
                >
                  DRIVING
                </span>
                <span
                  className={`block text-transparent bg-clip-text bg-gradient-to-r from-[#DC143C] to-[#FF6B6B] filter drop-shadow-[0_0_20px_rgba(220,20,60,0.5)] transition-all duration-700 delay-[600ms] transform pr-2 ${showHeroText ? "translate-y-0 opacity-100" : "translate-y-[100%] opacity-0"}`}
                >
                  LEGACY
                </span>
              </div>
            ...
            <div
              className={`flex justify-center w-full transition-all duration-1000 delay-[300ms] transform opacity-0 hidden`}
            >
        ...
        <div
          className={`absolute bottom-6 left-0 w-full flex flex-col items-center justify-center z-30 transition-all duration-1000 transform cursor-pointer ${showButton ? "translate-y-0 opacity-100" : "translate-y-[20px] opacity-0"}`}
        >
          <Button
            variant="custom"
          ...
          >
            <svg
              className="w-10 h-10 text-[#E31E24] opacity-40"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="1"
            ...
            <svg
              className="w-10 h-10 text-[#E31E24] opacity-70"
              viewBox="0 0 24 24"
              fill="none"
              stroke="currentColor"
              strokeWidth="1"
      ...
      >
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[600px] md:h-[850px] rounded-[4rem] overflow-hidden border border-white/10 shadow-[0_0_80px_-20px_rgba(227,30,36,0.2)] group">
              ...
              <div className="absolute bottom-12 left-12 right-12 z-20">
                <div className="flex items-center gap-4 mb-4">
                  ...
                  <span className="text-white font-black uppercase italic tracking-widest text-xs md:text-sm">
          ...
          <ScrollReveal direction="left" delay={400}>
            <div>
              <h4 className="text-brand-red text-sm font-bold uppercase tracking-[0.5em] mb-4">
              ...
              <div className="space-y-6 text-gray-400 text-base leading-relaxed mb-10 text-justify hyphens-auto tracking-tight break-words">
                ...
                <p>
                  Located in{" "}
                  <strong className="text-white">Chavindra, Bhiwandi</strong>,
                  our workshop is open for everyone who values honest service
                  and good relations. We have earned a strong reputation because
                  we treat customers like family. When you come to us, you get
                  our promise of excellence and complete customer satisfaction.
                </p>
              </div>
              ...
              <Link to="/why-us">
                <Button
                  variant="custom"
                  className="bg-transparent border border-white text-white hover:bg-white hover:text-black px-8 py-3 rounded-full uppercase font-bold tracking-widest transition-all"
                >
                  Why Choose Us?
                </Button>
              </Link>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <ScrollReveal direction="up">
            <div className="text-center mb-16">
              <h4 className="text-brand-red text-xs font-bold uppercase tracking-[0.3em] mb-4">
                Our Methodology
              </h4>
              ...
              <p className="text-gray-400 text-base max-w-3xl mx-auto">
                Transparency, precision, and passion. We follow a meticulous
                four-step process to ensure your vehicle transformation exceeds
            ...
            {[
              ...
              <ScrollReveal key={idx} direction="up" delay={idx * 150}>
                <div className="group relative p-6 bg-black border border-white/5 rounded-[2.5rem] overflow-hidden hover:border-brand-red/50 transition-all duration-500 h-full">
                  ...
                  <span className="text-5xl font-black text-brand-red/10 group-hover:text-brand-red/20 transition-all duration-700 block mb-6 italic">
                    {item.step}
                  </span>
                  <h3 className="text-sm md:text-base font-black text-white mb-4 uppercase italic tracking-tighter group-hover:text-brand-red transition-colors duration-500 whitespace-nowrap">
                    {item.title}
                  </h3>
                  <p className="text-gray-400 text-sm leading-relaxed text-justify hyphens-auto tracking-tight font-medium break-words">
                    {item.desc}
                  </p>
      ...
      <div className="py-10 bg-black overflow-hidden relative border-t border-b border-white/10">
        <div className="max-w-7xl w-full mx-auto px-6 mb-8 text-center relative z-10">
          <h3 className="text-[#E31E24] font-bold uppercase tracking-[0.3em] text-sm md:text-lg glow-text">
            We Work For
          </h3>
        </div>
              ...
              {[...Array(3)].map((_, i) => (
                <React.Fragment key={i}>
                  {[
                    {
                      name: "Maruti Suzuki",
                      src: "/assets/car_logos/suzuki.svg",
                    },
                    ...
                    {
                      name: "Volkswagen",
                      src: "/assets/car_logos/volkswagen.svg",
                    },
      ...
      <div className="py-12 bg-black relative">
        <div className="max-w-7xl w-full mx-auto px-6 mb-8 flex items-end justify-between">
          <ScrollReveal direction="down">
            <h2 className="text-2xl md:text-4xl font-black text-white uppercase italic tracking-tighter">
              Premium{" "}
              <span className="text-[#E31E24]">Accessories & Styling</span>
            </h2>
          </ScrollReveal>
        </div>
        ...
        <div className="md:hidden w-full overflow-x-auto pb-8 px-6 flex gap-4 snap-x snap-mandatory [&::-webkit-scrollbar]:hidden [-ms-overflow-style:'none'] [scrollbar-width:'none']">
          {services.map((service, idx) => (
            <div
              key={idx}
              className="flex-shrink-0 w-[85vw] snap-center h-[380px] relative rounded-3xl overflow-hidden border border-white/10 group"
            >
              <div className="absolute inset-0 bg-gradient-to-b from-[#1a0505] to-black opacity-60" />
              <img
                src={service.img}
                alt={service.title}
                className="absolute inset-0 w-full h-full object-contain pb-10"
                loading="lazy"
              />
              <div className="absolute bottom-0 left-0 right-0 px-6 pb-4 pt-10 bg-gradient-to-t from-black via-black/90 to-transparent">
                ...
                <p className="text-gray-400 text-xs font-medium mb-3 leading-relaxed">
                  {service.desc}
                </p>
                <Link
                  to={service.link}
                  className="text-brand-red font-bold uppercase tracking-widest text-xs flex items-center gap-2 hover:text-white transition-colors"
                >
                  Explore <span>→</span>
                </Link>
              </div>
            ...
            {[...Array(3)].map((_, i) => (
              <React.Fragment key={i}>
                {services.map((service, idx) => (
                  <div
                    key={`${i}-${idx}`}
                    className="w-[450px] flex-shrink-0 relative h-auto min-h-[450px] rounded-[3.5rem] overflow-hidden group border border-white/10 bg-black hover:border-brand-red/50 transition-all duration-500 flex flex-col"
                  >
                    {/* Image Section */}
                    ...
                    <div className="relative flex-grow w-full px-8 pb-8 pt-4 bg-black z-10 flex flex-col justify-between">
                      <div>
                        <h3 className="text-xl font-black text-white uppercase italic mb-2 tracking-tighter whitespace-nowrap">
                          {service.title}
                        </h3>
                        <p className="text-gray-300 mb-6 font-medium text-sm leading-relaxed text-justify hyphens-auto tracking-tight break-words">
                          {service.desc}
                        </p>
                      </div>
                      <Link
                        to={service.link}
                        className="inline-flex items-center gap-2 text-brand-red font-bold uppercase tracking-widest text-xs group-hover:gap-4 transition-all hover:text-white mt-auto"
                      >
                ...
                {faqs.map((faq, idx) => (
                  <ScrollReveal key={idx} direction="up" delay={idx * 100}>
                    ...
                    >
                      ...
                      >
                        <span
                          className={`text-base md:text-lg font-bold uppercase italic tracking-tight transition-colors duration-300 pr-4 ${openFaq === idx ? "text-[#E31E24]" : "text-white group-hover:text-gray-200"}`}
                        >
                          {faq.q}
                        </span>
                        <span
                          className={`flex-shrink-0 w-8 h-8 flex items-center justify-center rounded-full border transition-all duration-300 ${openFaq === idx ? "bg-[#E31E24] border-[#E31E24] rotate-45" : "border-white/10 group-hover:border-[#E31E24] group-hover:text-[#E31E24]"}`}
                        >
                          <svg
                            className={`w-4 h-4 transition-colors ${openFaq === idx ? "fill-white" : "fill-current"}`}
                            viewBox="0 0 24 24"
                          >
          ...
          <ScrollReveal direction="up">
            <div className="text-center mb-12">
              ...
              <p className="text-gray-400 text-base max-w-2xl mx-auto">
                Come see where the magic happens. We are located in the heart of
                Bhiwandi.
              </p>
            </div>
          </ScrollReveal>
      ...
      >
        <div
          className={`absolute inset-0 bg-black/60 backdrop-blur-md transition-opacity duration-700 ${hoveredImg ? "opacity-100" : "opacity-0"}`}
        />
        ...
        {hoveredImg && (
          <div className="relative w-full max-w-5xl aspect-square md:aspect-video flex items-center justify-center animate-in zoom-in-75 fade-in duration-500">
            ...
            <div
              className="absolute inset-x-0 h-1 bg-gradient-to-r from-transparent via-brand-red to-transparent z-20 animate-scan pointer-events-none"
              style={{
